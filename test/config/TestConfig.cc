...
void TestConfig::setUp()
{
    ...
    string subdir = program_name + "/config";
    ...
    std::ofstream confFile (program_name + "/config/RDMA.conf", std::ofstream::out);
...
void TestConfig::tearDown()
{
    ...
    string filename = program_name + "/config/RDMA.conf";
    std::remove(filename.c_str());
    string subfolder = program_name + "/config";
